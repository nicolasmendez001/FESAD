    ...
    <div class="navbar-default sidebar" role="navigation">
        <div class="sidebar-nav slimscrollsidebar">
            ...
            <ul class="nav" id="side-menu">
                ...
                <li>
                    <a href="<?= base_url() ?>csalones" class="waves-effect" ><i class="fa fa-building fa-fw" aria-hidden="true"></i>Sitios</a>
                </li>
                <li>
                ...
                <div class="col-md-10">
                    <div class="panel panel-primary">
                        <div class="panel-heading">
                            <h3 class="panel-title"><strong>Sitios</strong></h3>
                        ...
                        <div class="panel-body">
                            <input type="text" class="form-control" id="dev-table-filter" data-action="filter" data-filters="#dev-table" placeholder="Filtrar Sitio" />
                        </div>
...
<!--                                        <a href="--><?php //echo base_url('csalones/eliminar/' . $fila->id_salon); ?><!--"><button class="btn btn-danger">Eliminar</button></a>-->
            ...
            <div class="row bg-title">
                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                    <h4 class="page-title">Agregar Sitio</h4>
                </div>
