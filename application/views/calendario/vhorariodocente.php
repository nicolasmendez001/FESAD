        ...
        <div class="sidebar-nav slimscrollsidebar">
            ...
            <ul class="nav" id="side-menu">
                <li style="padding: 70px 0 0;">
                    <a href="" class="waves-effect" style="border-left: none"><i class="fa fa-clock-o fa-fw"
                                                                                 aria-hidden="true"></i>Panel
                        Inicial</a>
                </li>
                <li>
                ...
                <li>
                    <a href="<?= base_url() ?>csalones" class="waves-effect"><i class="fa fa-building fa-fw"
                                                                                aria-hidden="true"></i>Sitios</a>
                </li>
                <li>
                ...
                <div class="panel panel-primary">
                    ...
                    <div class="panel-body">
                        <input type="text" class="form-control" id="dev-table-filter" data-action="filter"
                               data-filters="#dev-table" placeholder="Filtrar clases asignadas"/>
                    </div>
...
<!--<script src="-->
<? //= base_url() ?><!--/resources/dashboard/plugins/bower_components/toast-master/js/jquery.toast.js"></script>-->
