    ...
    <div class="navbar-default sidebar" role="navigation">
        <div class="sidebar-nav slimscrollsidebar">
            ...
            <ul class="nav" id="side-menu">
                ...
                <li>
                    <a href="<?= base_url() ?>casignaturas" class="waves-effect" style="border-left: none"><i class="fa fa-book fa-fw"
                                                                                    aria-hidden="true"></i>Asignaturas</a>
                </li>
                <li>
                    <a href="<?= base_url() ?>cperiodos" class="waves-effect"><i class="fa fa-calendar fa-fw"
                    ...
                    <div class="white-box">
                        ...
                        <div class="panel-body">
                            <input type="text" class="form-control" id="dev-table-filter" data-action="filter"
                                   data-filters="#example" placeholder="Filtrar Periodo"/>
                        </div>
