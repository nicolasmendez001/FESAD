    ...
    <div id="page-wrapper">
        <div class="container-fluid">
            ...
            <div class="col-md-12 col-xs-12" id="nuevodocente">
                <div class="white-box">
                    <form class="form-horizontal form-material" action="<?php echo base_url('cdocentes/editar/' . $fila->id_docente); ?>" method="POST" enctype="multipart/form-data" id="formulario">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-12">
                                <input type="email"  name="correo" id="correo" placeholder="nombre@correo.com" class="form-control form-control-line" required> </div>
                        </div>
                        <div class="form-group">
                            <label class="col-md-12">Teléfono</label>
                            <div class="col-md-12">
                                <input type="text" name="telefono" id="telefono" placeholder="123 456 7890" class="form-control form-control-line" required> </div>
                        </div>
                        <div class="form-group">
                            <div class="col-sm-12">
...
<script>
    ...
    document.getElementById("correo").value= "<?php echo $fila->correo?>"
    document.getElementById("telefono").value= "<?php echo $fila->telefono?>"
<?php }?>
