...
<head>
    ...
    <link rel="icon" type="image/png" sizes="16x16"
          href="<?= base_url() ?>/resources/dashboard/plugins/images/favicon.png">
    ...
    <!-- Menu CSS -->
    <link href="<?= base_url() ?>/resources/dashboard/plugins/bower_components/sidebar-nav/dist/sidebar-nav.min.css"
          rel="stylesheet">
    <!-- toast CSS -->
    <link href="<?= base_url() ?>/resources/dashboard/plugins/bower_components/toast-master/css/jquery.toast.css"
          rel="stylesheet">
    <!-- morris CSS -->
    <link href="<?= base_url() ?>/resources/dashboard/plugins/bower_components/morrisjs/morris.css" rel="stylesheet">
    <!-- chartist CSS -->
    <link href="<?= base_url() ?>/resources/dashboard/plugins/bower_components/chartist-js/dist/chartist.min.css"
          rel="stylesheet">
    <link href="<?= base_url() ?>/resources/dashboard/plugins/bower_components/chartist-plugin-tooltip-master/dist/chartist-plugin-tooltip.css"
          rel="stylesheet">
    <!-- animation CSS -->
            ...
            <div class="top-left-part">
                ...
                <a class="logo" href="index.html">
                    <!-- Logo icon image, you can use font-icon also --><b>
                        ...
                        <!--                        <img src="-->
                        <? //= base_url() ?><!--/resources/dashboard/plugins/images/admin-logo.png" alt="home" class="dark-logo" /><!--This is light logo icon-->
                        <!--                        <img src="-->-->
                        <? ////= base_url() ?><!--<!--/resources/dashboard/plugins/images/admin-logo-dark.png" alt="home" class="light-logo" />-->
                        -->
                        <!--                    </b>-->
                        <!-- Logo text image you can use text also --><span class="hidden-xs">
                            <img src="<?= base_url() ?>/resources/dashboard/plugins/images/admin-text-dark.png"
            ...
            <ul class="nav navbar-top-links navbar-right pull-right">
                ...
                <li>
                    <a class="profile-pic" href="#"> <img
                                src="<?= base_url() ?>/resources/dashboard/plugins/images/users/varun.jpg"
                                alt="user-img" width="36" class="img-circle"><b class="hidden-xs">FESAD</b></a>
                </li>
            </ul>
        </div>
        <!-- /.navbar-header -->
        ...
        <div class="sidebar-nav slimscrollsidebar">
            ...
            <ul class="nav" id="side-menu">
                <li style="padding: 70px 0 0;">
                    <a href="<?= base_url() ?>" class="waves-effect" style="border-left: none"><i class="fa fa-clock-o fa-fw"
                                                                                aria-hidden="true"></i>Panel Inicial</a>
                </li>
                <li>
                    <a href="<?= base_url() ?>cdocentes" class="waves-effect" style="border-left: none"><i
                                class="fa fa-user fa-fw" aria-hidden="true"></i>Docentes</a>
                </li>
                <li>
                    <a href="<?= base_url() ?>cprograma" class="waves-effect" style="border-left: none"><i
                                class="fa fa-list-alt fa-fw" aria-hidden="true"></i>Programas</a>
                </li>
                <li>
        ...
        <div class="container-fluid">
            <div class="row bg-title">
                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                    <h4 class="page-title">Panel de Administración Asignatura</h4>
                </div>
                    ...
                    <div class="white-box">
                        ...
                        <div class="panel-body">
                            <input type="text" class="form-control" id="dev-table-filter" data-action="filter"
                                   data-filters="#example" placeholder="Filtrar Asignatura"/>
                        </div>
...
<!--                            <a href="--><?//= base_url() ?><!--Cpruebas/reporte">-->
...
<!--                    </div>-->
            ...
            <div class="row bg-title">
                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                    <h4 class="page-title">Agregar Asignatura</h4>
                </div>
            </div>
                ...
                <div class="white-box">
                    <form class="form-horizontal form-material" action="" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-12">
                                <input type="text" name="creditos" placeholder="3"
                                       class="form-control form-control-line" required></div>
                        </div>
                        <div class="form-group">
                            <label class="col-md-12">Semestre</label>
                            <div class="col-md-12">
                                <input type="text" name="semestre" placeholder="1"
                                       class="form-control form-control-line" required></div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-md-12">
                                <select class="form-control pull-right row b-none" name="programa">
                                    <?php foreach ($programas->result() as $fila) { ?>
                                        <option value="<?php echo $fila->id_programa?>"><?php echo $fila->nombre ?></option>
                                    <?php } ?>
                                </select>
                            </div>
                        </div>
                            ...
                            <div class="col-md-12">
                                <select class="form-control pull-right row b-none" name="periodo">
                                    <?php foreach ($periodos->result() as $fila) { ?>
                                        <option value="<?php echo $fila->id_periodo?>"><?php echo "Semestre ".$fila->semestre." del año ".$fila->anio ?></option>
                                    <?php } ?>
                                </select>
                            </div>
                        </div>
